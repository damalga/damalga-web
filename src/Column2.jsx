  ...
  return (
    <section className="col-2">
      <div className="projects topic">
        ...
        <p className="first extra-info">
          Open tech store and living lab driven by technology, economy,
      ...
      <div className="skills topic">
        ...
        <div className="design-composition">
          ...
          <p>
            With a strong mix of references and resources, I bring brand values
            to life across digital and print media. Check out my{" "}
            <a
              className="link"
        ...
        <div className="systems-interfaces">
          ...
          <div className="system-interface-icons">
            <div className="system-interface css">
              ...
              <p className="text">
                I build interfaces from the ground up, keeping structure and
                style in sync. HTML and CSS are my foundation, extended with{" "}
                <a
                  className="link"
                ...
                is my weapon to deploy clean and fast.
              </p>
              <p className="extra-info">
                I've worked across many cores and CMSs, adapting easily to
            ...
            <div className="system-interface">
              ...
              <p className="text">
                When it comes to interaction and logic I stay close to vanilla
                JavaScript. I'm comfortable enough with{" "}
                ...
                fits better with how I build and think. It lets me handle both
                templating and state with clarity.
              </p>
              <p className="extra-info">
                I used to use{" "}
            ...
            <div className="system-interface">
              ...
              <p className="text">
                ...
                . I must recognize its impact in software development without
                forgetting it's built on the collective human knowledge found in
                docs and places like{" "}
                <a
                  className="link"
              ...
              <p className="extra-info">
                I still value going to the source and understanding what each
                line does before anything.
              </p>
            </div>
            <div className="system-interface">
              <img
                src={bash}
                alt="bash cli command line interface linux tui terminal user interface rust cargo"
              />
              <p className="text">
                <a
                  className="link"
                ...
                really fascinates me and combining it with CLI tools to do more
                complex tasks drives me crazy. I work comfortably in GNU/Linux
                and the terminal.
              </p>
              <p className="extra-info">
                I'm also exploring{" "}
                ...
                and its ecosystem, building TUIs with{" "}
                <a className="link" href="https://ratatui.rs/" target="_blank">
                  ratatui
                </a>{" "}
                and cross-compiling with{" "}
                <a
                  className="link"
