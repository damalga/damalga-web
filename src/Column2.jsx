      ...
      <div className="projects topic">
        ...
        <div className="hackeed project">
          ...
          <p className="bold">Hackeed<br></br>
            ...
            <br></br>
            <a className="link" href="https://hackeed.es" target="_blank">Website</a> · <a className="link" href="https://hackeed.es/blog" target="_blank">Blog</a>
          </p>
        </div>
        <p className="first extra-info">
        ...
        <div className="systems-interfaces">
          ...
          <div className="system-interface-icons">
            ...
            <div className="system-interface">
              ...
              <p className="extra-info">
                I used to use <a className="link" href="https://gulpjs.com/" target="_blank">Gulp</a> for styling pipelines and live reload. Also <a className="link" href="https://webpack.js.org/" target="_blank">Webpack</a> for bundling, but <a className="link" href="https://vitejs.dev/" target="_blank">Vite</a> now handles all of that faster and cleaner.
              </p>
            </div>
            <div className="system-interface">
              <img src={git} alt="git github" />
              <p className="text">I work comfortably with <a className="link" href="https://git-scm.com/" target="_blank">Git</a>. I've tried AI tools like <a className="link" href="https://www.anthropic.com/product/claude-code" target="_blank">Claude Code</a>. I must recognize its impact in software development without forgetting it's built on the collective human knowledge found in docs and places like <a className="link" href="https://stackoverflow.com/" target="_blank">StackOverflow</a>.
              </p>
              <p className="extra-info">
            ...
            <div className="system-interface">
              ...
              <p className="text"><a className="link" href="https://www.gnu.org/software/bash/" target="_blank">Bash</a> really fascinates me and combining it with CLI tools to do more complex tasks drives me crazy. I work comfortably in GNU/Linux and the terminal.</p>
              <p className="extra-info">
                I'm also exploring <a className="link" href="https://www.rust-lang.org/" target="_blank">Rust</a> and its ecosystem, building TUIs with <a className="link" href="https://ratatui.rs/" target="_blank">ratatui</a> and cross-compiling with <a className="link" href="https://doc.rust-lang.org/cargo/" target="_blank">Cargo</a> (from x86 to ARM) for <a className="link" href="https://www.openwrt.org/" target="_blank">OpenWrt</a> routers and <a className="link" href="https://www.raspberrypi.com/" target="_blank">Raspberry Pis</a>.
              </p>
            </div>
          </div>
        </div>
