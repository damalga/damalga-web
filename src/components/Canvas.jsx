...
function Canvas() {
  ...
  useEffect(() => {
    ...
    curtains.onError(() => {
      console.error("Curtains failed to initialize");
    });

    curtains.onSuccess(() => {
      console.log("Curtains successfully initialized");
      ...
      const ripples = new PingPongPlane(curtains, canvasRef.current, {
        ...
        uniforms: {
          ...
          velocity: { name: "uVelocity", type: "2f", value: mouse.velocity },
          resolution: {
            name: "uResolution",
            type: "2f",
          ...
          viscosity: { name: "uViscosity", type: "1f", value: 8 },
          speed: { name: "uSpeed", type: "1f", value: 3 },
          size: { name: "uSize", type: "1f", value: 6 },
          dissipation: { name: "uDissipation", type: "1f", value: 0.968 },
        },
      });
      ...
      const onMouseMove = (e) => {
        ...
        if (!mouse.lastTime) mouse.lastTime = performance.now();
      ...
      const renderPassUniforms = {
        ...
        hue: { name: "uHue", type: "1f", value: 16 },
        saturation: { name: "uSaturation", type: "1f", value: 1 },
        bgColor: { name: "uBgColor", type: "3f", value: [255, 255, 255] },
      };

      const renderPass = new ShaderPass(curtains, {
      ...
      gui
        .add(renderPass.uniforms.hue, "value", 0, Math.PI * 2, 0.01)
        .name("Hue");
      gui
        .add(renderPass.uniforms.saturation, "value", 0, 3, 0.0625)
        .name("Saturation");
      gui
        .addColor({ bgColor: { r: 255, g: 255, b: 255 } }, "bgColor")
        .onChange((value) => {
