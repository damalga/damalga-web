    ...
    <section className='col-1'>
      ...
      <div className='edu topic'>
        ...
        <div className='erasmus school'>
          <p><b>Erasmus+</b> in <a className='link' href="https://www.aalto.fi/en/school-of-arts-design-and-architecture" target="_blank"><b>Aalto University</b> school of arts, design and achitecture</a> (Finland).
